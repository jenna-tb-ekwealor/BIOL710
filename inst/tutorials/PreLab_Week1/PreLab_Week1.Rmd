...
ggplot(data = plant, aes(x =day, y = males)) + 
  geom_point()
```
...
to see the total number of flowers in 1629. We could repeat this once for each day, but there is a faster way. 
...
ggplot(data = plant, aes(x = day, y = total)) + 
  geom_line()
```
