...
*Due*: Monday (beginning of class time, Pacific time)


# extra stuff for Jenna to move to in-lab activities:
...
2. In the plot above does the normal probability plot for the grams of protein in daisies pollen look similar to the plots created for the simulated data?  That is, do the plots provide evidence that the grams of protein are nearly normal? Explain.
...
Submit your Markdown document and knitted file on Canvas as:

LastName-LastName-LastName-Week3.Rmd  (add a third last name if applicable)

LastName-LastName-LastName-Week3.html
